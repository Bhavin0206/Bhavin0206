...
- Built full-stack features using **Next.js, React.js, and Laravel**  
- Optimized backend performance by fixing **N+1 query issues**  
- Improved API stability using **caching and Typesense search**  
...
- Replaces traditional visiting cards with smart digital sharing  
...
### 🔹 Kisan Cloud
IoT agriculture data platform for large-scale data processing.  
- Built systems for handling agricultural and sensor data  
...
- Centralized platform for profiles, photos, and videos  
